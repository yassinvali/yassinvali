...
namespace AttitudeAdmin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = $"{model.UserName}@Admin.test" };
        ...
        private ActionResult RedirectToLocal(string returnUrl)
        {
            ...
            SignInManager.AuthenticationManager.SignIn();
            ...
            {
                return RedirectToAction("Report21", "Reports");
